...
# StrategyReadonlyDbContextFactory, which reads the HTB_CONNECTION_STRING env var.
#
...
COPY src/strategy/HTB.Strategy.Shared/HTB.Strategy.Shared.csproj src/strategy/HTB.Strategy.Shared/
