...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HTB.Shared.MarketData.Domain.Candle", b =>
                {
            ...
            modelBuilder.Entity("HTB.Shared.MarketData.Domain.Exchange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HTB.Shared.MarketData.Domain.Symbol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HTB.Shared.MarketData.Domain.Candle", b =>
                {
                    b.HasOne("HTB.Shared.MarketData.Domain.Symbol", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HTB.Shared.MarketData.Domain.Symbol", b =>
                {
                    b.HasOne("HTB.Shared.MarketData.Domain.Exchange", null)
                        .WithMany()
